...
<div id="header" class="container">
	...
	<div id="menu">
		<ul>
			<li class="current_page_item"><a href="sess1.php" accesskey="1" title="">Homepage</a></li>
...
<div id="banner">
	<div class="container">
		...
		<div class="title">
			<h2>Welcome to Club INSEA TV</h2>
			<span class="byline">L'INSEA en images</span>
		</div>
		<p>INSEA TV est un club charge de mediatiser,filmer les evenememts de INSTITUT NATIONAL DE STATISTIQUE
ET D’ECONOMIE APPLIQUEE</p>
		<ul class="actions">
			<li><a href="#" class="button">Mr7ba</a></li>
		</ul>
	</div>
</div>
